# Chapter 3: Core Components & Requirements
...
Per the system rules defined in `AGENTS.md`, the user interface must be fully localized to Arabic and adopt a Right-to-Left (RTL) layout. The terminology and tone must balance professional clarity with simple, everyday market terms in Egypt ("Ù„ØºØ© Ø³ÙˆÙ‚ Ù…Ù‡Ù†ÙŠØ© ÙˆÙ…Ø¨Ø³Ø·Ø©").
...
| :--- | :--- | :--- | :--- |
| **Customer** | Ø§Ù„Ù…Ø´ØªØ±ÙŠ / Ø§Ù„Ø¹Ù…ÙŠÙ„ | **Ø§Ù„Ø¹Ù…ÙŠÙ„** | Customer identity |
| **Product / Item** | Ø§Ù„Ù…Ù†ØªØ¬ / Ø§Ù„Ø³Ù„Ø¹Ø© | **Ø§Ù„Ø¨Ø¶Ø§Ø¹Ø©** or **Ø§Ù„ØµÙ†Ù** | Catalog items |
| **Cash Registry / Vault** | Ø§Ù„ØµÙ†Ø¯ÙˆÙ‚ / Ø§Ù„Ø­Ø³Ø§Ø¨ Ø§Ù„Ù†Ù‚Ø¯ÙŠ | **Ø§Ù„Ø®Ø²Ù†Ø©** | Cash drawer / cash flow |
| **Invoice / Receipt** | Ø¥ÙŠØµØ§Ù„ Ø§Ù„Ø¨ÙŠØ¹ / Ø³Ù†Ø¯ Ø§Ù„ØµØ±Ù | **Ø§Ù„ÙØ§ØªÙˆØ±Ø©** or **Ø§Ù„ÙˆØµÙ„** | Transaction slip |
| **Ledger / Book** | Ø¯ÙØªØ± Ø§Ù„Ø£Ø³ØªØ§Ø° / Ø§Ù„Ø­Ø³Ø§Ø¨Ø§Øª Ø§Ù„Ø¹Ø§Ù…Ø© | **Ø§Ù„Ø¯ÙØªØ±** | Historical logs & journals |
| **Cash Payment** | Ø§Ù„Ø¯ÙØ¹ Ø§Ù„ÙÙˆØ±ÙŠ | **Ø§Ù„Ù†Ù‚Ø¯ÙŠØ©** or **Ø§Ù„ÙƒØ§Ø´** | Immediate settlement |
| **Installments** | Ø¯ÙØ¹Ø§Øª Ù…Ø¬Ø¯ÙˆÙ„Ø© | **Ø§Ù„Ù‚Ø³Ø·** or **Ø§Ù„Ø£Ù‚Ø³Ø§Ø·** | Credit schedule |
| **Salesperson** | Ù…Ù†Ø¯ÙˆØ¨ Ø§Ù„Ù…Ø¨ÙŠØ¹Ø§Øª | **Ø§Ù„Ù…Ù†Ø¯ÙˆØ¨** | Agent or representative |
| **Branch / Warehouse** | Ø§Ù„ÙØ±Ø¹ / Ø§Ù„Ù…Ø®Ø²Ù† | **Ø§Ù„Ù…Ø®Ø²Ù†** or **Ø§Ù„ÙØ±Ø¹** | Local warehouse |
| **Down Payment** | Ø§Ù„Ø¯ÙØ¹Ø© Ø§Ù„Ù…Ù‚Ø¯Ù…Ø© | **Ø§Ù„Ù…Ù‚Ø¯Ù…** or **Ø§Ù„Ø¯ÙØ¹Ø© Ø§Ù„Ù…Ù‚Ø¯Ù…Ø©** | Installment initial cash |
| **Supplier** | Ø§Ù„Ù…ÙˆØ±Ø¯ | **Ø§Ù„Ù…ÙˆØ±Ø¯** or **Ø§Ù„Ù…ÙˆØ±Ø¯ÙŠÙ†** | Vendor for restock |
| **Expense** | Ø§Ù„Ù…ØµØ±ÙˆÙØ§Øª | **Ø§Ù„Ù…ØµØ§Ø±ÙŠÙ** | Overhead costs |
| **License / Code** | Ø§Ù„ØªØ±Ø®ÙŠØµ / ÙƒÙˆØ¯ Ø§Ù„ØªÙØ¹ÙŠÙ„ | **Ø§Ù„ØªØ±Ø®ÙŠØµ** or **Ø§Ù„ÙƒÙˆØ¯** | Verification code |
...
*   **Do not use** excessive street slang or informal terminology (e.g., avoid terms like "ÙŠØ§ Ù…Ø¹Ù„Ù…", "ÙŠØ§ Ø¨Ø§Ø´Ø§").
...
```
      ...
      â”‚   HMAC-SHA256 Signature  â”‚        Masked Data       â”‚
      â”‚        (36 Bits)         â”‚         (44 Bits)        â”‚
      â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
                    â”‚                          â”‚
                    â””â”€â–º Mask Generation â”€â”€â”€â”€â”€â”€â”€â”¼â”€â–º XOR Masking
                        (final_sig Shift/OR)   â”‚
                                               â–¼
                                     â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
                                     â”‚ Machine ID Hash   â”‚ (32 Bits)
                                     â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
                                     â”‚ Date Code Offset  â”‚ (8 Bits)
                                     â”œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¤
                                     â”‚ Product ID        â”‚ (4 Bits)
...
### 1. Login Flow (Ø´Ø§Ø´Ø© ØªØ³Ø¬ÙŠÙ„ Ø§Ù„Ø¯Ø®ÙˆÙ„)
*   Provides text input fields for Username (`Ø§Ø³Ù… Ø§Ù„Ù…Ø³ØªØ®Ø¯Ù…`) and Password (`ÙƒÙ„Ù…Ø© Ø§Ù„Ù…Ø±ÙˆØ±`).
...
### 2. Company Setup Wizard (Ù…Ø³Ø§Ø¹Ø¯ Ø¥Ø¹Ø¯Ø§Ø¯ Ø§Ù„Ø´Ø±ÙƒØ©)
*   A multi-step setup wizard presented on empty system initializations:
    *   **Step 1: Company Profile**: Enter Company Name (`Ø§Ø³Ù… Ø§Ù„Ø´Ø±ÙƒØ©`), Phone 1 (`Ø±Ù‚Ù… Ø§Ù„ØªÙ„ÙŠÙÙˆÙ† Ø§Ù„Ø£Ø³Ø§Ø³ÙŠ`), Phone 2 (`Ø±Ù‚Ù… Ø§Ù„ØªÙ„ÙŠÙÙˆÙ† Ø§Ù„Ø¨Ø¯ÙŠÙ„`), and Receipt Footer text (`Ø±Ø³Ø§Ù„Ø© Ù†Ù‡Ø§ÙŠØ© Ø§Ù„ÙØ§ØªÙˆØ±Ø©`).
...
### 3. Dashboard (Ø´Ø§Ø´Ø© Ø§Ù„ØªØ­ÙƒÙ… / Ø§Ù„ØµÙØ­Ø© Ø§Ù„Ø±Ø¦ÙŠØ³ÙŠØ©)
*   Displays KPI badges: Total Sales (`Ø¥Ø¬Ù…Ø§Ù„ÙŠ Ø§Ù„Ù…Ø¨ÙŠØ¹Ø§Øª`), Cash Registry (`Ø§Ù„Ø®Ø²Ù†Ø©`), Active Sync Devices (`Ø§Ù„Ø£Ø¬Ù‡Ø²Ø© Ø§Ù„Ù†Ø´Ø·Ø©`), and Pending Approvals Queue (`Ù‚Ø§Ø¦Ù…Ø© Ø§Ù„Ø§Ù†ØªØ¸Ø§Ø± Ù„Ù„ÙˆØµÙ„Ø§Øª`).
...
### 4. Products List (Ø¯ÙØªØ± Ø§Ù„Ø£ØµÙ†Ø§Ù ÙˆØ§Ù„Ø¨Ø¶Ø§Ø¹Ø©)
*   Displays the product inventory.
*   Supports details popup showing current stock, cost price, and historical movement ledger.
*   Provides actions to update item commission rules (`ØªØ­Ø¯ÙŠØ« Ø§Ù„Ù…Ù†Ø¯Ø¨Ø©`) or log manual stock adjustments (`DEFICIT` / `SURPLUS`).

### 5. Sales Receipts View (ÙØ§ØªÙˆØ±Ø© Ø§Ù„Ø¨ÙŠØ¹ / Ø§Ù„ÙˆØµÙ„)
...
### 6. Suppliers & Purchase Invoices (Ø§Ù„Ù…ÙˆØ±Ø¯ÙŠÙ† ÙˆÙÙˆØ§ØªÙŠØ± Ø§Ù„Ø´Ø±Ø§Ø¡)
*   CRUD interface for Suppliers (`Ø§Ù„Ù…ÙˆØ±Ø¯ÙŠÙ†`).
*   Form to record Restock (`Ø´Ø±Ø§Ø¡ Ø¨Ø¶Ø§Ø¹Ø©`) or Return (`Ù…Ø±ØªØ¬Ø¹ Ø¨Ø¶Ø§Ø¹Ø©`) purchase invoices.
*   Correctly adjusts stock levels in the ledger on save.

### 7. Expenses View (Ø¯ÙØªØ± Ø§Ù„Ù…ØµØ§Ø±ÙŠÙ)
*   Log overhead payments (rent, electricity, salaries) by Branch and Month/Year.

### 8. License Activation Page (Ø´Ø§Ø´Ø© Ø§Ù„ØªÙ†Ø´ÙŠØ·)
*   Displays the Hardware Signature Hash (`Ø±Ù‚Ù… Ø§Ù„Ø¬Ù‡Ø§Ø²`).
*   Includes text field to submit the activation key code (`ÙƒÙˆØ¯ Ø§Ù„ØªÙ†Ø´ÙŠØ·`).
*   Shows active plans, remaining invoice limits (`Ø±ØµÙŠØ¯ Ø§Ù„ÙÙˆØ§ØªÙŠØ±`), and cloud synchronization limits.


## 5. Reports and Analytics Module

### 5.1 Profit and Loss Report (الأرباح والخسائر)
This component calculates and displays the profitability of inventory items.
- **Unified Table Concept:** Combines Cash and Installment sales in a unified data structure to prevent fragmented views.
- **Commissions Separation:** Distinguishes between Sales Commission (مندبة) and Collection Commission (عمولة تحصيل). For cash sales, the Collection Commission column explicitly displays كاش to prevent confusion.
- **Sorting Algorithm:** Relies on \local_id\ as the default sort column to maintain chronological ledger consistency. Secondary sorts on dual-value columns (e.g., Unit / Total) always apply the sort operation on the Total value (e.g., total profit, total revenue) to highlight high-impact items.
- **Report Filtering Types:** Supports three declarative views (oth, verage, 	otal) to dynamically compress the React Virtual DOM table without re-fetching data.
