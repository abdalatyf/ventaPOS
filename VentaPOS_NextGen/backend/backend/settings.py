...
SECRET_KEY = 'django-insecure-6p9soc+u5%7)+9-c+p+7c2n!i9kxrc%&gu02y_76wd%mvk+qz3'
...
MIDDLEWARE = [
    ...
    'api.middleware.LicenseEnforcementMiddleware',
]
...
DATABASES = {
    ...
    'system': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': os.path.join(VENTAPOS_SYSTEM_DIR, 'system.sqlite3'),
    }
}

DATABASE_ROUTERS = ['api.db_router.SystemDBRouter']
