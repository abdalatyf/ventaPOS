  ...
  "elements": [
    {
      "type": "filter_bar",
      "inputs": [
        { "type": "select", "name": "salesperson", "icon": "IconUser", "label": "???????" },
        { "type": "select", "name": "report_type", "icon": "IconFileAnalytics", "label": "??? ???????", "options": ["both", "average", "total"] },
        { "type": "select", "name": "sale_type", "icon": "IconFilter", "label": "??? ?????", "options": ["all", "cash", "installment"] },
        { "type": "text", "name": "search", "icon": "IconSearch", "label": "??? ????" }
      ],
    ...
    },
    {
      ...
      "columns": 6,
      "cards": [
        { "label": "????????", "color": "text-azure" },
        { "label": "??? ??????", "color": "text-danger" },
        { "label": "?????? ?????", "color": "text-warning" },
        { "label": "?????? ?????", "color": "text-warning" },
        { "label": "?????????", "link": "/reports/expenses" },
        { "label": "?????? ???????", "color": "text-success", "bg": "bg-success-lt" }
      ]
    },
    {
      "type": "table",
