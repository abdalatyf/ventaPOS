...
if __name__ == '__main__':
    ...
    def on_closing():
        print("⏳ جاري حفظ ومزامنة البيانات، الرجاء الانتظار...")
        try:
            from salesapp.sync_agent import push_data_background
            push_data_background()
        except Exception as e:
            print(f"⚠️ خطأ أثناء المزامنة عند الإغلاق: {e}")

    window = webview.create_window(
        'Venta POS - Secure Mode', 
        LOCAL_URL,
        width=1200, 
        height=800,
        resizable=True,
